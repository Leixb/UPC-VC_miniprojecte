...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \include{030-preprocessat}
    \include{040-descriptors}
    \include{045-classificador}
    \include{050-experiments}
    \include{060-resultats}
    \include{061-conclusions}
    \include{070-funcions}
